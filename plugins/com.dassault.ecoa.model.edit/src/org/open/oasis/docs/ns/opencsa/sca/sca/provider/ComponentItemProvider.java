...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.ns.opencsa.sca.sca.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentItemProvider extends CommonExtensionBaseItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 scaPackage.Literals.COMPONENT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(scaPackage.Literals.COMPONENT__IMPLEMENTATION_GROUP);
			childrenFeatures.add(scaPackage.Literals.COMPONENT__GROUP);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(scaPackage.Literals.COMPONENT__GROUP,
				 FeatureMapUtil.createEntry
					(scaPackage.Literals.COMPONENT__SERVICE,
		...
		newChildDescriptors.add
			(createChildParameter
				(scaPackage.Literals.COMPONENT__GROUP,
				 FeatureMapUtil.createEntry
					(scaPackage.Literals.COMPONENT__REFERENCE,
		...
		newChildDescriptors.add
			(createChildParameter
				(scaPackage.Literals.COMPONENT__GROUP,
				 FeatureMapUtil.createEntry
					(scaPackage.Literals.COMPONENT__PROPERTY,
