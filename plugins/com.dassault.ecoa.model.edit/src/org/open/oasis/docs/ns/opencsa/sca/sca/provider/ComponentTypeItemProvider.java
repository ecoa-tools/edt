...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.ns.opencsa.sca.sca.ComponentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentTypeItemProvider extends CommonExtensionBaseItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(scaPackage.Literals.COMPONENT_TYPE__GROUP);
		}
	...
	public String getText(Object object) {
		return getString("_UI_ComponentType_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(scaPackage.Literals.COMPONENT_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(scaPackage.Literals.COMPONENT_TYPE__SERVICE,
					 scaFactory.eINSTANCE.createServiceType())));

		newChildDescriptors.add
			(createChildParameter
				(scaPackage.Literals.COMPONENT_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(scaPackage.Literals.COMPONENT_TYPE__REFERENCE,
		...
		newChildDescriptors.add
			(createChildParameter
				(scaPackage.Literals.COMPONENT_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(scaPackage.Literals.COMPONENT_TYPE__PROPERTY,
