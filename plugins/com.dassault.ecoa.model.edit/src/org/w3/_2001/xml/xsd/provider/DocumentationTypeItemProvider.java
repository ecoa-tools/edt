...
/**
 * This is the item provider adapter for a {@link org.w3._2001.xml.xsd.DocumentationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentationTypeItemProvider 
	...
	public String getText(Object object) {
		String label = ((DocumentationType)object).getSource();
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == polPackage.Literals.DOCUMENT_ROOT__INSERTION_POLICIES ||
			childFeature == polPackage.Literals.DOCUMENT_ROOT__USE ||
			childFeature == modPackage.Literals.DOCUMENT_ROOT__MODULE_BEHAVIOUR ||
			childFeature == modPackage.Literals.DOCUMENT_ROOT__USE ||
			childFeature == udpPackage.Literals.DOCUMENT_ROOT__PLATFORM ||
			childFeature == udpPackage.Literals.DOCUMENT_ROOT__UDP_BINDING ||
			childFeature == binPackage.Literals.DOCUMENT_ROOT__BIN_DESC ||
			childFeature == binPackage.Literals.DOCUMENT_ROOT__USE ||
			childFeature == EcoaCommon20Package.Literals.DOCUMENT_ROOT__USE ||
			childFeature == viewPackage.Literals.DOCUMENT_ROOT__USE ||
			childFeature == viewPackage.Literals.DOCUMENT_ROOT__VIEW ||
			childFeature == depPackage.Literals.DOCUMENT_ROOT__DEPLOYMENT ||
			childFeature == depPackage.Literals.DOCUMENT_ROOT__USE ||
			childFeature == impPackage.Literals.DOCUMENT_ROOT__COMPONENT_IMPLEMENTATION ||
			childFeature == impPackage.Literals.DOCUMENT_ROOT__USE ||
			childFeature == interPackage.Literals.DOCUMENT_ROOT__SERVICE_DEFINITION ||
			childFeature == interPackage.Literals.DOCUMENT_ROOT__USE ||
			childFeature == qosPackage.Literals.DOCUMENT_ROOT__SERVICE_INSTANCE_QO_S ||
			childFeature == qosPackage.Literals.DOCUMENT_ROOT__USE ||
			childFeature == logPackage.Literals.DOCUMENT_ROOT__LOGICAL_SYSTEM ||
			childFeature == logPackage.Literals.DOCUMENT_ROOT__USE ||
			childFeature == projPackage.Literals.DOCUMENT_ROOT__ECOA_PROJECT ||
			childFeature == projPackage.Literals.DOCUMENT_ROOT__USE ||
			childFeature == typPackage.Literals.DOCUMENT_ROOT__LIBRARY ||
			childFeature == typPackage.Literals.DOCUMENT_ROOT__USE ||
			childFeature == uidPackage.Literals.DOCUMENT_ROOT__ID_MAP ||
			childFeature == scaPackage.Literals.DOCUMENT_ROOT__COMPONENT_TYPE ||
			childFeature == scaPackage.Literals.DOCUMENT_ROOT__COMPOSITE ||
			childFeature == scaPackage.Literals.DOCUMENT_ROOT__DOCUMENTATION ||
			childFeature == scaPackage.Literals.DOCUMENT_ROOT__EXTENSIONS ||
			childFeature == scaPackage.Literals.DOCUMENT_ROOT__IMPLEMENTATION_TYPE ||
			childFeature == scaPackage.Literals.DOCUMENT_ROOT__VALUE ||
			childFeature == scaPackage.Literals.DOCUMENT_ROOT__CONTRIBUTION ||
			childFeature == scaPackage.Literals.DOCUMENT_ROOT__IMPLEMENTATION_COMPOSITE ||
			childFeature == scaExtPackage.Literals.DOCUMENT_ROOT__INSTANCE ||
			childFeature == scaExtPackage.Literals.DOCUMENT_ROOT__INTERFACE;
