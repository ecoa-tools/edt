...
/**
 * This is the item provider adapter for a {@link technology.ecoa.cross.platforms.view._2.UseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UseType_library_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UseType_library_feature", "_UI_UseType_type"),
				 viewPackage.Literals.USE_TYPE__LIBRARY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_UseType_type") :
			getString("_UI_UseType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UseType.class)) {
			case viewPackage.USE_TYPE__LIBRARY:
