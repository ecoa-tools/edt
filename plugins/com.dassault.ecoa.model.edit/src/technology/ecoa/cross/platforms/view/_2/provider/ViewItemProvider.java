...
/**
 * This is the item provider adapter for a {@link technology.ecoa.cross.platforms.view._2.View} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_assembly_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_assembly_feature", "_UI_View_type"),
				 viewPackage.Literals.VIEW__ASSEMBLY,
				 true,
				 false,
				 false,
	...
	protected void addLogicalSystemPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_logicalSystem_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_logicalSystem_feature", "_UI_View_type"),
				 viewPackage.Literals.VIEW__LOGICAL_SYSTEM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 viewPackage.Literals.VIEW__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(viewPackage.Literals.VIEW__GROUP);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(viewPackage.Literals.VIEW__GROUP,
				 FeatureMapUtil.createEntry
					(viewPackage.Literals.VIEW__COMPOSITE,
		...
		newChildDescriptors.add
			(createChildParameter
				(viewPackage.Literals.VIEW__GROUP,
				 FeatureMapUtil.createEntry
					(viewPackage.Literals.VIEW__WIRE_MAPPING,
		...
		newChildDescriptors.add
			(createChildParameter
				(viewPackage.Literals.VIEW__GROUP,
				 FeatureMapUtil.createEntry
					(viewPackage.Literals.VIEW__EUIDS_BINDING,
