...
/**
 * This is the item provider adapter for a {@link technology.ecoa.deployment._2.ComponentLog} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentLogItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 depPackage.Literals.COMPONENT_LOG__ENABLED_LEVELS,
				 true,
				 false,
				 false,
	...
	protected void addInstanceNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentLog_instanceName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentLog_instanceName_feature", "_UI_ComponentLog_type"),
				 depPackage.Literals.COMPONENT_LOG__INSTANCE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(depPackage.Literals.COMPONENT_LOG__MODULE_LOG);
		}
	...
	public String getText(Object object) {
		String label = ((ComponentLog)object).getInstanceName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(depPackage.Literals.COMPONENT_LOG__MODULE_LOG,
