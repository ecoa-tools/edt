...
/**
 * This is the item provider adapter for a {@link technology.ecoa.deployment._2.ComputingNodeConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComputingNodeConfigurationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComputingNodeConfiguration_computingNode_feature", "_UI_ComputingNodeConfiguration_type"),
				 depPackage.Literals.COMPUTING_NODE_CONFIGURATION__COMPUTING_NODE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 depPackage.Literals.COMPUTING_NODE_CONFIGURATION__SCHEDULING_INFORMATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ComputingNodeConfiguration)object).getComputingNode();
