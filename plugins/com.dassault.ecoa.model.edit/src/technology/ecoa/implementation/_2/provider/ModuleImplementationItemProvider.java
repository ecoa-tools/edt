...
/**
 * This is the item provider adapter for a {@link technology.ecoa.implementation._2.ModuleImplementation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleImplementationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 impPackage.Literals.MODULE_IMPLEMENTATION__LANGUAGE,
				 true,
				 false,
				 false,
	...
	protected void addModuleTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModuleImplementation_moduleType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModuleImplementation_moduleType_feature", "_UI_ModuleImplementation_type"),
				 impPackage.Literals.MODULE_IMPLEMENTATION__MODULE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ModuleImplementation_name_feature", "_UI_ModuleImplementation_type"),
				 impPackage.Literals.MODULE_IMPLEMENTATION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
