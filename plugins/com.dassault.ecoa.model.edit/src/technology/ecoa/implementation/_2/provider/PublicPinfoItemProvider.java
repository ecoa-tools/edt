...
/**
 * This is the item provider adapter for a {@link technology.ecoa.implementation._2.PublicPinfo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PublicPinfoItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PublicPinfo_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PublicPinfo_name_feature", "_UI_PublicPinfo_type"),
				 impPackage.Literals.PUBLIC_PINFO__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PublicPinfo.class)) {
			case impPackage.PUBLIC_PINFO__NAME:
