...
/**
 * This is the item provider adapter for a {@link technology.ecoa.implementation._2.RequestResponse} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequestResponseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 impPackage.Literals.REQUEST_RESPONSE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(impPackage.Literals.REQUEST_RESPONSE__INPUT);
			childrenFeatures.add(impPackage.Literals.REQUEST_RESPONSE__OUTPUT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RequestResponse.class)) {
			case impPackage.REQUEST_RESPONSE__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case impPackage.REQUEST_RESPONSE__INPUT:
			case impPackage.REQUEST_RESPONSE__OUTPUT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(impPackage.Literals.REQUEST_RESPONSE__INPUT,
				 impFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(impPackage.Literals.REQUEST_RESPONSE__OUTPUT,
				 impFactory.eINSTANCE.createParameter()));
	}
