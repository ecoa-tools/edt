...
/**
 * This is the item provider adapter for a {@link technology.ecoa.interface_._2.Operations} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationsItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(interPackage.Literals.OPERATIONS__GROUP);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(interPackage.Literals.OPERATIONS__GROUP,
				 FeatureMapUtil.createEntry
					(interPackage.Literals.OPERATIONS__DATA,
		...
		newChildDescriptors.add
			(createChildParameter
				(interPackage.Literals.OPERATIONS__GROUP,
				 FeatureMapUtil.createEntry
					(interPackage.Literals.OPERATIONS__EVENT,
		...
		newChildDescriptors.add
			(createChildParameter
				(interPackage.Literals.OPERATIONS__GROUP,
				 FeatureMapUtil.createEntry
					(interPackage.Literals.OPERATIONS__REQUESTRESPONSE,
