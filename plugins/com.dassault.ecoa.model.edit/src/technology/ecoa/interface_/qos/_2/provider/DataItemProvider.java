...
/**
 * This is the item provider adapter for a {@link technology.ecoa.interface_.qos._2.Data} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 qosPackage.Literals.DATA__MAX_AGEING,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 qosPackage.Literals.DATA__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 qosPackage.Literals.DATA__NOTIFICATION_MAX_HANDLING_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(qosPackage.Literals.DATA__HIGHEST_RATE);
			childrenFeatures.add(qosPackage.Literals.DATA__LOWEST_RATE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(qosPackage.Literals.DATA__HIGHEST_RATE,
				 qosFactory.eINSTANCE.createOperationRate()));

		newChildDescriptors.add
			(createChildParameter
				(qosPackage.Literals.DATA__LOWEST_RATE,
				 qosFactory.eINSTANCE.createOperationRate()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == qosPackage.Literals.DATA__HIGHEST_RATE ||
			childFeature == qosPackage.Literals.DATA__LOWEST_RATE;
