...
/**
 * This is the item provider adapter for a {@link technology.ecoa.interface_.qos._2.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMaxHandlingTimePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Max Handling Time feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMaxHandlingTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_maxHandlingTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_maxHandlingTime_feature", "_UI_Event_type"),
				 qosPackage.Literals.EVENT__MAX_HANDLING_TIME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 qosPackage.Literals.EVENT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(qosPackage.Literals.EVENT__HIGHEST_RATE);
			childrenFeatures.add(qosPackage.Literals.EVENT__LOWEST_RATE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(qosPackage.Literals.EVENT__HIGHEST_RATE,
				 qosFactory.eINSTANCE.createOperationRate()));

		newChildDescriptors.add
			(createChildParameter
				(qosPackage.Literals.EVENT__LOWEST_RATE,
				 qosFactory.eINSTANCE.createOperationRate()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == qosPackage.Literals.EVENT__HIGHEST_RATE ||
			childFeature == qosPackage.Literals.EVENT__LOWEST_RATE;
