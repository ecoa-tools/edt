...
/**
 * This is the item provider adapter for a {@link technology.ecoa.interface_.qos._2.Operations} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationsItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(qosPackage.Literals.OPERATIONS__GROUP);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(qosPackage.Literals.OPERATIONS__GROUP,
				 FeatureMapUtil.createEntry
					(qosPackage.Literals.OPERATIONS__DATA,
		...
		newChildDescriptors.add
			(createChildParameter
				(qosPackage.Literals.OPERATIONS__GROUP,
				 FeatureMapUtil.createEntry
					(qosPackage.Literals.OPERATIONS__EVENT,
		...
		newChildDescriptors.add
			(createChildParameter
				(qosPackage.Literals.OPERATIONS__GROUP,
				 FeatureMapUtil.createEntry
					(qosPackage.Literals.OPERATIONS__REQUESTRESPONSE,
