...
/**
 * This is the item provider adapter for a {@link technology.ecoa.interface_.qos._2.RequestResponse} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequestResponseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 qosPackage.Literals.REQUEST_RESPONSE__CALLBACK_MAX_HANDLING_TIME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 qosPackage.Literals.REQUEST_RESPONSE__MAX_RESPONSE_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RequestResponse_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RequestResponse_name_feature", "_UI_RequestResponse_type"),
				 qosPackage.Literals.REQUEST_RESPONSE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(qosPackage.Literals.REQUEST_RESPONSE__HIGHEST_RATE);
			childrenFeatures.add(qosPackage.Literals.REQUEST_RESPONSE__LOWEST_RATE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(qosPackage.Literals.REQUEST_RESPONSE__HIGHEST_RATE,
				 qosFactory.eINSTANCE.createOperationRate()));

		newChildDescriptors.add
			(createChildParameter
				(qosPackage.Literals.REQUEST_RESPONSE__LOWEST_RATE,
				 qosFactory.eINSTANCE.createOperationRate()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == qosPackage.Literals.REQUEST_RESPONSE__HIGHEST_RATE ||
			childFeature == qosPackage.Literals.REQUEST_RESPONSE__LOWEST_RATE;
