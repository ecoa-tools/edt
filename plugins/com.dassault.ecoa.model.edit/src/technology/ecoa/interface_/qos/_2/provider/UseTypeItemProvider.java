...
/**
 * This is the item provider adapter for a {@link technology.ecoa.interface_.qos._2.UseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 qosPackage.Literals.USE_TYPE__LIBRARY,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UseType.class)) {
			case qosPackage.USE_TYPE__LIBRARY:
