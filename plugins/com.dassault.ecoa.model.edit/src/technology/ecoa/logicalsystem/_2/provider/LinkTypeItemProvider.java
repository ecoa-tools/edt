...
/**
 * This is the item provider adapter for a {@link technology.ecoa.logicalsystem._2.LinkType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkType_from_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkType_from_feature", "_UI_LinkType_type"),
				 logPackage.Literals.LINK_TYPE__FROM,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 logPackage.Literals.LINK_TYPE__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addToPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkType_to_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkType_to_feature", "_UI_LinkType_type"),
				 logPackage.Literals.LINK_TYPE__TO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(logPackage.Literals.LINK_TYPE__THROUGHPUT);
			childrenFeatures.add(logPackage.Literals.LINK_TYPE__LATENCY);
			childrenFeatures.add(logPackage.Literals.LINK_TYPE__TRANSPORT_BINDING);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(logPackage.Literals.LINK_TYPE__THROUGHPUT,
				 logFactory.eINSTANCE.createThroughputType()));

		newChildDescriptors.add
			(createChildParameter
				(logPackage.Literals.LINK_TYPE__LATENCY,
				 logFactory.eINSTANCE.createLatencyType()));

		newChildDescriptors.add
			(createChildParameter
				(logPackage.Literals.LINK_TYPE__TRANSPORT_BINDING,
				 logFactory.eINSTANCE.createTransportBindingType()));
	}
