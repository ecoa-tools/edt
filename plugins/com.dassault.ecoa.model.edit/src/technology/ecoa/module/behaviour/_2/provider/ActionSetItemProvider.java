...
/**
 * This is the item provider adapter for a {@link technology.ecoa.module.behaviour._2.ActionSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionSetItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(modPackage.Literals.ACTION_SET__GROUP);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(modPackage.Literals.ACTION_SET__GROUP,
				 FeatureMapUtil.createEntry
					(modPackage.Literals.ACTION_SET__LOOP,
		...
		newChildDescriptors.add
			(createChildParameter
				(modPackage.Literals.ACTION_SET__GROUP,
				 FeatureMapUtil.createEntry
					(modPackage.Literals.ACTION_SET__COMPUTING,
		...
		newChildDescriptors.add
			(createChildParameter
				(modPackage.Literals.ACTION_SET__GROUP,
				 FeatureMapUtil.createEntry
					(modPackage.Literals.ACTION_SET__OPERATION_CALL,
