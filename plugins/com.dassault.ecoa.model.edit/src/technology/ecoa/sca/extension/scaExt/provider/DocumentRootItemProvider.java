...
/**
 * This is the item provider adapter for a {@link technology.ecoa.sca.extension.scaExt.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentRootItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DocumentRoot_deployment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DocumentRoot_deployment_feature", "_UI_DocumentRoot_type"),
				 scaExtPackage.Literals.DOCUMENT_ROOT__DEPLOYMENT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 scaExtPackage.Literals.DOCUMENT_ROOT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(scaExtPackage.Literals.DOCUMENT_ROOT__INSTANCE);
			childrenFeatures.add(scaExtPackage.Literals.DOCUMENT_ROOT__INTERFACE);
		}
	...
	public String getText(Object object) {
		String label = ((DocumentRoot)object).getDeployment();
