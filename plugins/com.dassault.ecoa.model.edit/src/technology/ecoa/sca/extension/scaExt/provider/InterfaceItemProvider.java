...
/**
 * This is the item provider adapter for a {@link technology.ecoa.sca.extension.scaExt.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider extends org.open.oasis.docs.ns.opencsa.sca.sca.provider.InterfaceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_qos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_qos_feature", "_UI_Interface_type"),
				 scaExtPackage.Literals.INTERFACE__QOS,
				 true,
				 false,
				 false,
	...
	protected void addSyntaxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_syntax_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_syntax_feature", "_UI_Interface_type"),
				 scaExtPackage.Literals.INTERFACE__SYNTAX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Interface)object).getQos();
