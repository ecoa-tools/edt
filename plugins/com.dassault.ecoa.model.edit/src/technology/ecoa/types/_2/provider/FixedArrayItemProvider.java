...
/**
 * This is the item provider adapter for a {@link technology.ecoa.types._2.FixedArray} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FixedArrayItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FixedArray_comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FixedArray_comment_feature", "_UI_FixedArray_type"),
				 typPackage.Literals.FIXED_ARRAY__COMMENT,
				 true,
				 false,
				 false,
	...
	protected void addItemTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FixedArray_itemType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FixedArray_itemType_feature", "_UI_FixedArray_type"),
				 typPackage.Literals.FIXED_ARRAY__ITEM_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 typPackage.Literals.FIXED_ARRAY__MAX_NUMBER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FixedArray_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FixedArray_name_feature", "_UI_FixedArray_type"),
				 typPackage.Literals.FIXED_ARRAY__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_FixedArray_type") :
			getString("_UI_FixedArray_type") + " " + label;
	}
