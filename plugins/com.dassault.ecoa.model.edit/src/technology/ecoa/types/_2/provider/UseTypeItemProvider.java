...
/**
 * This is the item provider adapter for a {@link technology.ecoa.types._2.UseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 typPackage.Literals.USE_TYPE__LIBRARY,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UseType.class)) {
			case typPackage.USE_TYPE__LIBRARY:
