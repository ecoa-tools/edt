...
import EcoaCommon20.ProgrammingLanguage;
import EcoaCommon20.UseType;

import EcoaCommon20.util.EcoaCommon20Validator;
 ...
 * @generated
 */
public class EcoaCommon20PackageImpl extends EPackageImpl implements EcoaCommon20Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see EcoaCommon20.EcoaCommon20Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private EcoaCommon20PackageImpl() {
		super(eNS_URI, EcoaCommon20Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link EcoaCommon20Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static EcoaCommon20Package init() {
		if (isInited) return (EcoaCommon20Package)EPackage.Registry.INSTANCE.getEPackage(EcoaCommon20Package.eNS_URI);

		// Obtain or create and register package
		Object registeredEcoaCommon20Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		EcoaCommon20PackageImpl theEcoaCommon20Package = registeredEcoaCommon20Package instanceof EcoaCommon20PackageImpl ? (EcoaCommon20PackageImpl)registeredEcoaCommon20Package : new EcoaCommon20PackageImpl();
		...
		EValidator.Registry.INSTANCE.put
			(theEcoaCommon20Package,
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return EcoaCommon20Validator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theEcoaCommon20Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(EcoaCommon20Package.eNS_URI, theEcoaCommon20Package);
		return theEcoaCommon20Package;
	}
	 ...
	 * @generated
	 */
	public EcoaCommon20Factory getEcoaCommon20Factory() {
		return (EcoaCommon20Factory)getEFactoryInstance();
	}
