...
import technology.ecoa.cross.platforms.view._2.ProgrammingLanguage;
...
import technology.ecoa.cross.platforms.view._2.util.viewValidator;
...
public class viewPackageImpl extends EPackageImpl implements viewPackage {
	 ...
	 * @generated
	 */
	private EClass euiDsBindingEClass = null;
	 ...
	 * @generated
	 */
	private EClass specificBindingTypeEClass = null;
	 ...
	 * @see technology.ecoa.cross.platforms.view._2.viewPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getComposite_DeployedOnComputingPlatform() {
	 ...
	 * @generated
	 */
	public EClass getEUIDsBinding() {
		return euiDsBindingEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getEUIDsBinding_SpecificBinding() {
		return (EReference)euiDsBindingEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getEUIDsBinding_BoundToLinkId() {
		return (EAttribute)euiDsBindingEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getEUIDsBinding_EUIDs() {
		return (EAttribute)euiDsBindingEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getSpecificBindingType() {
		return specificBindingTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getSpecificBindingType_BoundToComputingPlatform() {
		return (EAttribute)specificBindingTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSpecificBindingType_EUIDs() {
		return (EAttribute)specificBindingTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getView_Group() {
	 ...
	 * @generated
	 */
	public EReference getView_Composite() {
	 ...
	 * @generated
	 */
	public EReference getView_WireMapping() {
	 ...
	 * @generated
	 */
	public EReference getView_EuidsBinding() {
	 ...
	 * @generated
	 */
	public EAttribute getView_Assembly() {
	 ...
	 * @generated
	 */
	public EAttribute getView_LogicalSystem() {
	...
	public void createPackageContents() {
		...
		createEAttribute(compositeEClass, COMPOSITE__DEPLOYED_ON_COMPUTING_PLATFORM);
		...
		euiDsBindingEClass = createEClass(EUI_DS_BINDING);
		createEReference(euiDsBindingEClass, EUI_DS_BINDING__SPECIFIC_BINDING);
		createEAttribute(euiDsBindingEClass, EUI_DS_BINDING__BOUND_TO_LINK_ID);
		createEAttribute(euiDsBindingEClass, EUI_DS_BINDING__EUI_DS);

		specificBindingTypeEClass = createEClass(SPECIFIC_BINDING_TYPE);
		createEAttribute(specificBindingTypeEClass, SPECIFIC_BINDING_TYPE__BOUND_TO_COMPUTING_PLATFORM);
		createEAttribute(specificBindingTypeEClass, SPECIFIC_BINDING_TYPE__EUI_DS);

		useTypeEClass = createEClass(USE_TYPE);
		createEAttribute(useTypeEClass, USE_TYPE__LIBRARY);

		viewEClass = createEClass(VIEW);
		createEAttribute(viewEClass, VIEW__GROUP);
		createEReference(viewEClass, VIEW__COMPOSITE);
		createEReference(viewEClass, VIEW__WIRE_MAPPING);
		createEReference(viewEClass, VIEW__EUIDS_BINDING);
		createEAttribute(viewEClass, VIEW__ASSEMBLY);
		createEAttribute(viewEClass, VIEW__LOGICAL_SYSTEM);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getComposite_DeployedOnComputingPlatform(), this.getNameId(), "deployedOnComputingPlatform", null, 1, 1, Composite.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getComposite_Name(), this.getNameId(), "name", null, 1, 1, Composite.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDocumentRoot_View(), this.getView(), null, "view", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		initEClass(euiDsBindingEClass, EUIDsBinding.class, "EUIDsBinding", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEUIDsBinding_SpecificBinding(), this.getSpecificBindingType(), null, "specificBinding", null, 0, -1, EUIDsBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEUIDsBinding_BoundToLinkId(), this.getNameId(), "boundToLinkId", null, 1, 1, EUIDsBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEUIDsBinding_EUIDs(), theXMLTypePackage.getAnyURI(), "eUIDs", null, 1, 1, EUIDsBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(specificBindingTypeEClass, SpecificBindingType.class, "SpecificBindingType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSpecificBindingType_BoundToComputingPlatform(), this.getNameId(), "boundToComputingPlatform", null, 1, 1, SpecificBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSpecificBindingType_EUIDs(), theXMLTypePackage.getAnyURI(), "eUIDs", null, 1, 1, SpecificBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getView_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1, View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getView_Composite(), this.getComposite(), null, "composite", null, 0, -1, View.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getView_WireMapping(), this.getWireMapping(), null, "wireMapping", null, 0, -1, View.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getView_EuidsBinding(), this.getEUIDsBinding(), null, "euidsBinding", null, 0, -1, View.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getView_Assembly(), this.getNameId(), "assembly", null, 1, 1, View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getView_LogicalSystem(), this.getNameId(), "logicalSystem", null, 1, 1, View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getView_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getComposite_DeployedOnComputingPlatform(),
		   source,
		   new String[] {
			   "kind", "attribute",
			   "name", "deployedOnComputingPlatform"
		   });
		addAnnotation
		  (getComposite_Name(),
		   source,
		...
		addAnnotation
		  (getEUIDsBinding_SpecificBinding(),
		   source,
		   new String[] {
			   "kind", "element",
		...
		addAnnotation
		  (specificBindingTypeEClass,
		   source,
		   new String[] {
			   "name", "specificBinding_._type",
			   "kind", "empty"
		   });
		addAnnotation
		  (getSpecificBindingType_BoundToComputingPlatform(),
		   source,
		   new String[] {
			   "kind", "attribute",
			   "name", "boundToComputingPlatform"
		   });
		addAnnotation
		  (getSpecificBindingType_EUIDs(),
		   source,
		   new String[] {
			   "kind", "attribute",
			   "name", "EUIDs"
