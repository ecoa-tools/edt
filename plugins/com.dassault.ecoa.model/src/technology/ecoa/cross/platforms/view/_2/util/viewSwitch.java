...
public class viewSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case viewPackage.EUI_DS_BINDING: {
				EUIDsBinding euiDsBinding = (EUIDsBinding)theEObject;
				T result = caseEUIDsBinding(euiDsBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case viewPackage.SPECIFIC_BINDING_TYPE: {
				SpecificBindingType specificBindingType = (SpecificBindingType)theEObject;
				T result = caseSpecificBindingType(specificBindingType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EUI Ds Binding</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EUI Ds Binding</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEUIDsBinding(EUIDsBinding object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Specific Binding Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Specific Binding Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSpecificBindingType(SpecificBindingType object) {
		return null;
	}
