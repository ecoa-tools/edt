 ...
 * </p>
 * <ul>
 *   <li>{@link technology.ecoa.deployment._2.impl.WireMappingImpl#getMappedOnLinkId <em>Mapped On Link Id</em>}</li>
 *   <li>{@link technology.ecoa.deployment._2.impl.WireMappingImpl#getSource <em>Source</em>}</li>
 *   <li>{@link technology.ecoa.deployment._2.impl.WireMappingImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WireMappingImpl extends MinimalEObjectImpl.Container implements WireMapping {
	...
	protected EClass eStaticClass() {
		return depPackage.Literals.WIRE_MAPPING;
	}
	...
	public void setMappedOnLinkId(String newMappedOnLinkId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, depPackage.WIRE_MAPPING__MAPPED_ON_LINK_ID, oldMappedOnLinkId, mappedOnLinkId));
	}
	...
	public void setSource(String newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, depPackage.WIRE_MAPPING__SOURCE, oldSource, source));
	}
	...
	public void setTarget(String newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, depPackage.WIRE_MAPPING__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case depPackage.WIRE_MAPPING__MAPPED_ON_LINK_ID:
				return getMappedOnLinkId();
			case depPackage.WIRE_MAPPING__SOURCE:
				return getSource();
			case depPackage.WIRE_MAPPING__TARGET:
				return getTarget();
		}
