...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Op Ref Activatable Fifo</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link technology.ecoa.implementation._2.impl.OpRefActivatableFifoImpl#getFifoSize <em>Fifo Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OpRefActivatableFifoImpl extends OpRefActivatableImpl implements OpRefActivatableFifo {
	/**
	 ...
	 * @generated
	 */
	protected OpRefActivatableFifoImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return impPackage.Literals.OP_REF_ACTIVATABLE_FIFO;
	}
	...
	public void setFifoSize(BigInteger newFifoSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, impPackage.OP_REF_ACTIVATABLE_FIFO__FIFO_SIZE, oldFifoSize, fifoSize, !oldFifoSizeESet));
	}
	...
	public void unsetFifoSize() {
		...
		fifoSizeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, impPackage.OP_REF_ACTIVATABLE_FIFO__FIFO_SIZE, oldFifoSize, FIFO_SIZE_EDEFAULT, oldFifoSizeESet));
	}
