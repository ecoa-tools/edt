...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Periodic Activation Profile</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link technology.ecoa.insertion.policy._2.impl.PeriodicActivationProfileImpl#getDeadline <em>Deadline</em>}</li>
 *   <li>{@link technology.ecoa.insertion.policy._2.impl.PeriodicActivationProfileImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link technology.ecoa.insertion.policy._2.impl.PeriodicActivationProfileImpl#getRelativePriority <em>Relative Priority</em>}</li>
 *   <li>{@link technology.ecoa.insertion.policy._2.impl.PeriodicActivationProfileImpl#getWcet <em>Wcet</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PeriodicActivationProfileImpl extends MinimalEObjectImpl.Container implements PeriodicActivationProfile {
	/**
	 ...
	 * @generated
	 */
	protected PeriodicActivationProfileImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return polPackage.Literals.PERIODIC_ACTIVATION_PROFILE;
	}
	...
	public void setDeadline(double newDeadline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, polPackage.PERIODIC_ACTIVATION_PROFILE__DEADLINE, oldDeadline, deadline, !oldDeadlineESet));
	}
	...
	public void unsetDeadline() {
		...
		deadlineESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, polPackage.PERIODIC_ACTIVATION_PROFILE__DEADLINE, oldDeadline, DEADLINE_EDEFAULT, oldDeadlineESet));
	}
	...
	public void setPeriod(double newPeriod) {
		...
		periodESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, polPackage.PERIODIC_ACTIVATION_PROFILE__PERIOD, oldPeriod, period, !oldPeriodESet));
	}
	...
	public void unsetPeriod() {
		...
		periodESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, polPackage.PERIODIC_ACTIVATION_PROFILE__PERIOD, oldPeriod, PERIOD_EDEFAULT, oldPeriodESet));
	}
	...
	public void setRelativePriority(BigInteger newRelativePriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, polPackage.PERIODIC_ACTIVATION_PROFILE__RELATIVE_PRIORITY, oldRelativePriority, relativePriority));
	}
	...
	public void setWcet(double newWcet) {
		...
		wcetESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, polPackage.PERIODIC_ACTIVATION_PROFILE__WCET, oldWcet, wcet, !oldWcetESet));
	}
	...
	public void unsetWcet() {
		...
		wcetESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, polPackage.PERIODIC_ACTIVATION_PROFILE__WCET, oldWcet, WCET_EDEFAULT, oldWcetESet));
	}
