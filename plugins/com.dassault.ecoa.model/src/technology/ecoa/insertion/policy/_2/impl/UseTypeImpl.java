 ...
 * </p>
 * <ul>
 *   <li>{@link technology.ecoa.insertion.policy._2.impl.UseTypeImpl#getLibrary <em>Library</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UseTypeImpl extends MinimalEObjectImpl.Container implements UseType {
	...
	protected EClass eStaticClass() {
		return polPackage.Literals.USE_TYPE;
	}
	...
	public void setLibrary(String newLibrary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, polPackage.USE_TYPE__LIBRARY, oldLibrary, library));
	}
