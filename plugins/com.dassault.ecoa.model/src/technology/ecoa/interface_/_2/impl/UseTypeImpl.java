 ...
 * </p>
 * <ul>
 *   <li>{@link technology.ecoa.interface_._2.impl.UseTypeImpl#getLibrary <em>Library</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UseTypeImpl extends MinimalEObjectImpl.Container implements UseType {
	...
	protected EClass eStaticClass() {
		return interPackage.Literals.USE_TYPE;
	}
	...
	public void setLibrary(String newLibrary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, interPackage.USE_TYPE__LIBRARY, oldLibrary, library));
	}
