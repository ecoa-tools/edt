 ...
 * </p>
 * <ul>
 *   <li>{@link technology.ecoa.interface_.qos._2.impl.UseTypeImpl#getLibrary <em>Library</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UseTypeImpl extends MinimalEObjectImpl.Container implements UseType {
	...
	protected EClass eStaticClass() {
		return qosPackage.Literals.USE_TYPE;
	}
	...
	public void setLibrary(String newLibrary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, qosPackage.USE_TYPE__LIBRARY, oldLibrary, library));
	}
