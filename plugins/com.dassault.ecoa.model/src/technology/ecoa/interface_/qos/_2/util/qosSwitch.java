...
public class qosSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case qosPackage.OPERATION_RATE: {
				OperationRate operationRate = (OperationRate)theEObject;
				T result = caseOperationRate(operationRate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case qosPackage.SERVICE_INSTANCE_QO_S: {
				ServiceInstanceQoS serviceInstanceQoS = (ServiceInstanceQoS)theEObject;
				T result = caseServiceInstanceQoS(serviceInstanceQoS);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Operation Rate</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Operation Rate</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOperationRate(OperationRate object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Instance Qo S</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Instance Qo S</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServiceInstanceQoS(ServiceInstanceQoS object) {
		return null;
	}
