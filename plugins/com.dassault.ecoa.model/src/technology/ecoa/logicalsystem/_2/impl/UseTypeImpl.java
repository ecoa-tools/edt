 ...
 * </p>
 * <ul>
 *   <li>{@link technology.ecoa.logicalsystem._2.impl.UseTypeImpl#getLibrary <em>Library</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UseTypeImpl extends MinimalEObjectImpl.Container implements UseType {
	...
	protected EClass eStaticClass() {
		return logPackage.Literals.USE_TYPE;
	}
	...
	public void setLibrary(String newLibrary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, logPackage.USE_TYPE__LIBRARY, oldLibrary, library));
	}
