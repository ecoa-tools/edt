 ...
 * </p>
 * <ul>
 *   <li>{@link technology.ecoa.module.behaviour._2.impl.UseTypeImpl#getLibrary <em>Library</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UseTypeImpl extends MinimalEObjectImpl.Container implements UseType {
	...
	protected EClass eStaticClass() {
		return modPackage.Literals.USE_TYPE;
	}
	...
	public void setLibrary(String newLibrary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, modPackage.USE_TYPE__LIBRARY, oldLibrary, library));
	}
