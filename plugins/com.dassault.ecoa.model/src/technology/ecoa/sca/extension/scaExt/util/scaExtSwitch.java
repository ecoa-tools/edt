 ...
 * @generated
 */
public class scaExtSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case scaExtPackage.IMPLEMENTATION_TYPE: {
			...
			case scaExtPackage.INSTANCE: {
				Instance instance = (Instance)theEObject;
				T result = caseInstance(instance);
				if (result == null) result = caseImplementation(instance);
				if (result == null) result = caseCommonExtensionBase(instance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scaExtPackage.INTERFACE: {
				Interface interface_ = (Interface)theEObject;
				T result = caseInterface(interface_);
				if (result == null) result = casesca_Interface(interface_);
				if (result == null) result = caseCommonExtensionBase(interface_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scaExtPackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scaExtPackage.WIRE_INFORMATION: {
				WireInformation wireInformation = (WireInformation)theEObject;
				T result = caseWireInformation(wireInformation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Wire Information</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Wire Information</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWireInformation(WireInformation object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casesca_Interface(org.open.oasis.docs.ns.opencsa.sca.sca.Interface object) {
		return null;
	}
