...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fixed Array</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link technology.ecoa.types._2.impl.FixedArrayImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link technology.ecoa.types._2.impl.FixedArrayImpl#getItemType <em>Item Type</em>}</li>
 *   <li>{@link technology.ecoa.types._2.impl.FixedArrayImpl#getMaxNumber <em>Max Number</em>}</li>
 *   <li>{@link technology.ecoa.types._2.impl.FixedArrayImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FixedArrayImpl extends MinimalEObjectImpl.Container implements FixedArray {
	...
	protected EClass eStaticClass() {
		return typPackage.Literals.FIXED_ARRAY;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, typPackage.FIXED_ARRAY__COMMENT, oldComment, comment));
	}
	...
	public void setItemType(String newItemType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, typPackage.FIXED_ARRAY__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public void setMaxNumber(String newMaxNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, typPackage.FIXED_ARRAY__MAX_NUMBER, oldMaxNumber, maxNumber));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, typPackage.FIXED_ARRAY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case typPackage.FIXED_ARRAY__COMMENT:
				return getComment();
			case typPackage.FIXED_ARRAY__ITEM_TYPE:
				return getItemType();
			case typPackage.FIXED_ARRAY__MAX_NUMBER:
				return getMaxNumber();
			case typPackage.FIXED_ARRAY__NAME:
				return getName();
		}
