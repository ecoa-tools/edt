...
public class uidPackageImpl extends EPackageImpl implements uidPackage {
	 ...
	 * @see technology.ecoa.uid._2.uidPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getIDMap_ID() {
		return (EReference)idMapEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(documentRootEClass, DOCUMENT_ROOT__ID_MAP);

		idEClass = createEClass(ID);
		createEAttribute(idEClass, ID__KEY);
		createEAttribute(idEClass, ID__VALUE);

		idMapEClass = createEClass(ID_MAP);
		createEReference(idMapEClass, ID_MAP__ID);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getDocumentRoot_IDMap(), this.getIDMap(), null, "iDMap", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		initEClass(idEClass, technology.ecoa.uid._2.ID.class, "ID", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getID_Key(), theXMLTypePackage.getString(), "key", null, 1, 1, technology.ecoa.uid._2.ID.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getID_Value(), theXMLTypePackage.getInt(), "value", null, 1, 1, technology.ecoa.uid._2.ID.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(idMapEClass, IDMap.class, "IDMap", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getIDMap_ID(), this.getID(), null, "iD", null, 0, -1, IDMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
