...
/**
 * This is the item provider adapter for a {@link edtdeployment.ModuleLog} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class ModuleLogItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EdtdeploymentPackage.Literals.MODULE_LOG__ENABLED_LEVELS,
				 true,
				 false,
				 false,
	...
	protected void addModuleInstancePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(new ItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ModuleLog_ModuleInstance_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ModuleLog_ModuleInstance_feature",
								"_UI_ModuleLog_type"),
						EdtdeploymentPackage.Literals.MODULE_LOG__MODULE_INSTANCE, true, false, true, null, null,
						null) {
					@Override
					public Collection<?> getChoiceOfValues(Object object) {
						Collection<?> choiceOfValues = super.getChoiceOfValues(object);
						Collection<Object> filteredChoices = new ArrayList<>();
						ModuleLog moduleLog = (ModuleLog) object;
						if (moduleLog.eContainer() instanceof ComponentLog componentLog
								&& componentLog.getComponentImplementation() != null) {
							for (Object choice : choiceOfValues) {
								if (choice == null || (choice instanceof ModuleInstance instance && Objects
										.equals(instance.eContainer(), componentLog.getComponentImplementation()))) {
	...
	public String getText(Object object) {
		String label = ((ModuleLog)object).getEnabledLevels();
