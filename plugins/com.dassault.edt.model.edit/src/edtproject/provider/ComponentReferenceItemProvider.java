...
/**
 * This is the item provider adapter for a {@link edtproject.ComponentReference} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class ComponentReferenceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDTProjectPackage.Literals.COMPONENT_REFERENCE__MULTIPLICITY,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentReference_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentReference_Name_feature", "_UI_ComponentReference_type"),
				 EDTProjectPackage.Literals.COMPONENT_REFERENCE__NAME,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		ComponentReference componentReference = (ComponentReference) object;
		String label = componentReference.getWireString();
