...
/**
 * This is the item provider adapter for a {@link edtproject.Composite} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addServiceLinksPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDTProjectPackage.Literals.COMPOSITE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDTProjectPackage.Literals.COMPOSITE__TARGET_NAMESPACE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Service Links feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addServiceLinksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Composite_ServiceLinks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Composite_ServiceLinks_feature", "_UI_Composite_type"),
				 EDTProjectPackage.Literals.COMPOSITE__SERVICE_LINKS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EDTProjectPackage.Literals.COMPOSITE__PROPERTIES);
			childrenFeatures.add(EDTProjectPackage.Literals.COMPOSITE__COMPONENTS);
			childrenFeatures.add(EDTProjectPackage.Literals.COMPOSITE__REFERENCES);
			childrenFeatures.add(EDTProjectPackage.Literals.COMPOSITE__SERVICES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EDTProjectPackage.Literals.COMPOSITE__PROPERTIES,
				 EDTProjectFactory.eINSTANCE.createProperty()));

		newChildDescriptors.add
			(createChildParameter
				(EDTProjectPackage.Literals.COMPOSITE__COMPONENTS,
				 EDTProjectFactory.eINSTANCE.createComponent()));

		newChildDescriptors.add
			(createChildParameter
				(EDTProjectPackage.Literals.COMPOSITE__REFERENCES,
				 EDTProjectFactory.eINSTANCE.createCompositeReference()));

		newChildDescriptors.add
			(createChildParameter
				(EDTProjectPackage.Literals.COMPOSITE__SERVICES,
				 EDTProjectFactory.eINSTANCE.createCompositeService()));
	}
