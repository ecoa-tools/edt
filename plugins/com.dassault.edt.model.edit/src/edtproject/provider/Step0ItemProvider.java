...
/**
 * This is the item provider adapter for a {@link edtproject.Step0} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Step0ItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public Step0ItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EDTProjectPackage.Literals.STEP0__TYPES);
			childrenFeatures.add(EDTProjectPackage.Literals.STEP0__ECOA_PREDEFINED_TYPES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Step0"));
	}
	...
	public String getText(Object object) {
		String label = ((Step0)object).getFolderName();
		return label == null || label.length() == 0 ?
			getString("_UI_Step0_type") :
			getString("_UI_Step0_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Step0.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EDTProjectPackage.Literals.STEP0__TYPES,
				 EDTTypeFactory.eINSTANCE.createLibrary()));

		newChildDescriptors.add
			(createChildParameter
				(EDTProjectPackage.Literals.STEP0__ECOA_PREDEFINED_TYPES,
