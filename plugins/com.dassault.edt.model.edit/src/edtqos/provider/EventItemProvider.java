...
/**
 * This is the item provider adapter for a {@link edtqos.Event} object. <!--
...
public class EventItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EdtqosPackage.Literals.EVENT__MAX_HANDLING_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		edtinterface.Event labelValue = ((Event) object).getServiceDefinitionEvent();
