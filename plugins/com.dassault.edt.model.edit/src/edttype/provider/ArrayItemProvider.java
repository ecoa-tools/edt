...
/**
 * This is the item provider adapter for a {@link edttype.Array} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ArrayItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addMaxNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Array_maxNumber_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Array_maxNumber_feature", "_UI_Array_type"),
				 EDTTypePackage.Literals.ARRAY__MAX_NUMBER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	 ...
	 * begin-user-doc --> No self referencing<!-- end-user-doc -->
	 * 
	 * @generated NOT
	 */
	protected void addItemTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(new ItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Array_ItemType_feature", "_UI_Array_type"),
						EDTTypePackage.Literals.ARRAY__ITEM_TYPE, true, false, true, null, null, null) {
					@Override
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Array_type")
				: getString("_UI_Array_type") + " " + ((Library) ((Array) object).eContainer()).getName() + ":" + label;
	}
