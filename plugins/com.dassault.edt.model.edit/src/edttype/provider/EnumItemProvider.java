...
/**
 * This is the item provider adapter for a {@link edttype.Enum} object. <!--
...
public class EnumItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDTTypePackage.Literals.ENUM__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EDTTypePackage.Literals.ENUM__VALUE);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Enum_type")
				: getString("_UI_Enum_type") + " " + ((Library) ((Enum) object).eContainer()).getName() + ":" + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(edttype.Enum.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EDTTypePackage.Literals.ENUM__VALUE,
				 EDTTypeFactory.eINSTANCE.createEnumValue()));
	}
