...
/**
 * This is the item provider adapter for a {@link edttype.RecordPredefined} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class RecordPredefinedItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public RecordPredefinedItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EDTTypePackage.Literals.RECORD_PREDEFINED__FIELD);
		}
	...
	/**
	 * This returns RecordPredefined.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RecordPredefined"));
	}
	...
	public String getText(Object object) {
		String label = ((RecordPredefined) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Record_type")
				: getString("_UI_Record_type") + " ECOA:" + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RecordPredefined.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EDTTypePackage.Literals.RECORD_PREDEFINED__FIELD,
				 EDTTypeFactory.eINSTANCE.createFieldPredefined()));
	}
