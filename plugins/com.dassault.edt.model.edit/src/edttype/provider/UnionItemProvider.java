...
/**
 * This is the item provider adapter for a {@link edttype.Union} object. <!--
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Union_comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Union_comment_feature", "_UI_Union_type"),
				 EDTTypePackage.Literals.UNION__COMMENT,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(new ItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Union_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Union_name_feature", "_UI_Union_type"),
						EDTTypePackage.Literals.UNION__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null) {
					@Override
					public void setPropertyValue(Object object, Object value) {
						Union typeToName = (Union) object;
	...
	protected void addWhenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Union_when_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Union_when_feature", "_UI_Union_type"),
				 EDTTypePackage.Literals.UNION__WHEN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Union_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Union_type_feature", "_UI_Union_type"),
				 EDTTypePackage.Literals.UNION__TYPE,
				 true,
				 false,
				 true,
				 null,
