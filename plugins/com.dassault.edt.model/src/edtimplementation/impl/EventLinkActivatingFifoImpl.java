...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Event Link Activating Fifo</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edtimplementation.impl.EventLinkActivatingFifoImpl#getId <em>Id</em>}</li>
 *   <li>{@link edtimplementation.impl.EventLinkActivatingFifoImpl#getReceiverFifoSize <em>Receiver Fifo Size</em>}</li>
 *   <li>{@link edtimplementation.impl.EventLinkActivatingFifoImpl#getSender <em>Sender</em>}</li>
 *   <li>{@link edtimplementation.impl.EventLinkActivatingFifoImpl#getReceiver <em>Receiver</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventLinkActivatingFifoImpl extends MinimalEObjectImpl.Container implements EventLinkActivatingFifo {
	/**
	 ...
	 * @generated
	 */
	protected EventLinkActivatingFifoImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EdtimplementationPackage.Literals.EVENT_LINK_ACTIVATING_FIFO;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdtimplementationPackage.EVENT_LINK_ACTIVATING_FIFO__ID, oldId, id, !oldIdESet));
	}
	...
	public void unsetId() {
		...
		idESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EdtimplementationPackage.EVENT_LINK_ACTIVATING_FIFO__ID, oldId, ID_EDEFAULT, oldIdESet));
	}
	...
	public void setReceiverFifoSize(BigInteger newReceiverFifoSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdtimplementationPackage.EVENT_LINK_ACTIVATING_FIFO__RECEIVER_FIFO_SIZE, oldReceiverFifoSize, receiverFifoSize, !oldReceiverFifoSizeESet));
	}
	...
	public void unsetReceiverFifoSize() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EdtimplementationPackage.EVENT_LINK_ACTIVATING_FIFO__RECEIVER_FIFO_SIZE, oldReceiverFifoSize, RECEIVER_FIFO_SIZE_EDEFAULT, oldReceiverFifoSizeESet));
	}
	...
	public EventLinkSender getSender() {
		if (sender != null && sender.eIsProxy()) {
			...
			if (sender != oldSender) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EdtimplementationPackage.EVENT_LINK_ACTIVATING_FIFO__SENDER, oldSender, sender));
			}
		}
		return sender;
	}
	...
	public void setSender(EventLinkSender newSender) {
		...
		sender = newSender;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdtimplementationPackage.EVENT_LINK_ACTIVATING_FIFO__SENDER, oldSender, sender));
	}
	...
	public DynamicTriggerEventReceiverInstance getReceiver() {
		if (receiver != null && receiver.eIsProxy()) {
			...
			if (receiver != oldReceiver) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EdtimplementationPackage.EVENT_LINK_ACTIVATING_FIFO__RECEIVER, oldReceiver, receiver));
			}
		}
		return receiver;
	}
	...
	public void setReceiver(DynamicTriggerEventReceiverInstance newReceiver) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdtimplementationPackage.EVENT_LINK_ACTIVATING_FIFO__RECEIVER, oldReceiver, receiver));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdtimplementationPackage.EVENT_LINK_ACTIVATING_FIFO__ID:
				return getId();
			case EdtimplementationPackage.EVENT_LINK_ACTIVATING_FIFO__RECEIVER_FIFO_SIZE:
				return getReceiverFifoSize();
			case EdtimplementationPackage.EVENT_LINK_ACTIVATING_FIFO__SENDER:
				if (resolve) return getSender();
				return basicGetSender();
			case EdtimplementationPackage.EVENT_LINK_ACTIVATING_FIFO__RECEIVER:
