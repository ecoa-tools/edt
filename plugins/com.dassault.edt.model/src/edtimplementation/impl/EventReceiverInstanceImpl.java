 ...
 * Receiver Instance</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edtimplementation.impl.EventReceiverInstanceImpl#getName <em>Name</em>}</li>
 *   <li>{@link edtimplementation.impl.EventReceiverInstanceImpl#getMTOperationRef <em>MT Operation Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventReceiverInstanceImpl extends MinimalEObjectImpl.Container implements EventReceiverInstance {
	/**
	 ...
	 * @generated
	 */
	protected EventReceiverInstanceImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EdtimplementationPackage.Literals.EVENT_RECEIVER_INSTANCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdtimplementationPackage.EVENT_RECEIVER_INSTANCE__NAME, oldName, name));
	}
	...
	public ModuleOperation getMTOperationRef() {
		if (mtOperationRef != null && mtOperationRef.eIsProxy()) {
			...
			if (mtOperationRef != oldMTOperationRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EdtimplementationPackage.EVENT_RECEIVER_INSTANCE__MT_OPERATION_REF, oldMTOperationRef, mtOperationRef));
			}
		}
	...
	public void setMTOperationRef(ModuleOperation newMTOperationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdtimplementationPackage.EVENT_RECEIVER_INSTANCE__MT_OPERATION_REF, oldMTOperationRef, mtOperationRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdtimplementationPackage.EVENT_RECEIVER_INSTANCE__NAME:
				return getName();
			case EdtimplementationPackage.EVENT_RECEIVER_INSTANCE__MT_OPERATION_REF:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == OperationInheritingFromMT.class) {
			switch (derivedFeatureID) {
				case EdtimplementationPackage.EVENT_RECEIVER_INSTANCE__MT_OPERATION_REF: return EdtimplementationPackage.OPERATION_INHERITING_FROM_MT__MT_OPERATION_REF;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == OperationInheritingFromMT.class) {
			switch (baseFeatureID) {
				case EdtimplementationPackage.OPERATION_INHERITING_FROM_MT__MT_OPERATION_REF: return EdtimplementationPackage.EVENT_RECEIVER_INSTANCE__MT_OPERATION_REF;
				default: return -1;
			}
		}
