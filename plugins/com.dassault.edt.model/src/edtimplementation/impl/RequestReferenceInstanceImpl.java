 ...
 * </p>
 * <ul>
 *   <li>{@link edtimplementation.impl.RequestReferenceInstanceImpl#getName <em>Name</em>}</li>
 *   <li>{@link edtimplementation.impl.RequestReferenceInstanceImpl#getSDOperationRef <em>SD Operation Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequestReferenceInstanceImpl extends MinimalEObjectImpl.Container implements RequestReferenceInstance {
	/**
	 ...
	 * @generated
	 */
	protected RequestReferenceInstanceImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EdtimplementationPackage.Literals.REQUEST_REFERENCE_INSTANCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdtimplementationPackage.REQUEST_REFERENCE_INSTANCE__NAME, oldName, name));
	}
	...
	public OperationType getSDOperationRef() {
		if (sdOperationRef != null && sdOperationRef.eIsProxy()) {
			...
			if (sdOperationRef != oldSDOperationRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EdtimplementationPackage.REQUEST_REFERENCE_INSTANCE__SD_OPERATION_REF, oldSDOperationRef, sdOperationRef));
			}
		}
	...
	public void setSDOperationRef(OperationType newSDOperationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdtimplementationPackage.REQUEST_REFERENCE_INSTANCE__SD_OPERATION_REF, oldSDOperationRef, sdOperationRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdtimplementationPackage.REQUEST_REFERENCE_INSTANCE__NAME:
				return getName();
			case EdtimplementationPackage.REQUEST_REFERENCE_INSTANCE__SD_OPERATION_REF:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == OperationInheritingFromSD.class) {
			switch (derivedFeatureID) {
				case EdtimplementationPackage.REQUEST_REFERENCE_INSTANCE__SD_OPERATION_REF: return EdtimplementationPackage.OPERATION_INHERITING_FROM_SD__SD_OPERATION_REF;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == OperationInheritingFromSD.class) {
			switch (baseFeatureID) {
				case EdtimplementationPackage.OPERATION_INHERITING_FROM_SD__SD_OPERATION_REF: return EdtimplementationPackage.REQUEST_REFERENCE_INSTANCE__SD_OPERATION_REF;
				default: return -1;
			}
		}
