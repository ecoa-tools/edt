...
import com.dassault.edt.wizard.EcoadtProjectExportWizard;

/**
 * Project -> Export functionality handler.
 */
public class ExportProjectHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_SHELL) Shell shell) {
		...
		WizardDialog wizard = new WizardDialog(shell, new EcoadtProjectExportWizard());
		wizard.open();
	}
